...
- (UIImage *)jk_flip:(BOOL)isHorizontal {
...
- (UIImage *)jk_imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation([UIImage jk_degreesToRadians:degrees]);
    ...
    CGContextRotateCTM(bitmap, [UIImage jk_degreesToRadians:degrees]);

#
#  Be sure to run `pod spec lint iOS-Categories.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
A collection of useful Objective-C Categories extending iOS Frameworks such as Foundation,UIKit,CoreData,QuartzCore,CoreLocation,MapKit Etc.
                   DESC

  s.homepage     = "https://github.com/DamianSheldon/iOS-Categories"
  ...
  # Or just: s.author    = "Meiliang Dong"
  # s.authors            = { "Meiliang Dong" => "dongmeilianghy@sina.com" }
  # s.social_media_url   = "http://twitter.com/Meiliang Dong"
  ...
  s.source       = { :git => "https://github.com/DamianSheldon/iOS-Categories.git", :tag => s.version.to_s }
